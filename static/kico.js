...
本代码为AFox原创，并遵守 MIT 开源协议。欢迎访问我的主页：https://i.afox.love
...
(function (global, setting) {
    ...
    console.log("%c Kico Style %c https://i.afox.love ","color: #fff; margin: 1em 0; padding: 5px 0; background: #3498db;","margin: 1em 0; padding: 5px 0; background: #efefef;");
})(window);